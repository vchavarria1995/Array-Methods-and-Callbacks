...
console.log('task 1', finals2014[0]['Home Team Name']);
//(b) Away Team name for 2014 world cup final
console.log('task 1', finals2014[0]['Away Team Name']);
//(c) Home Team goals for 2014 world cup final
console.log('task 1', finals2014[0]['Home Team Goals']);
//(d) Away Team goals for 2014 world cup final
console.log('task 1', finals2014[0]['Away Team Goals']);
//(e) Winner of 2014 world cup final */
console.log('task 1', finals2014[0]['Win conditions']);
...
function getAverageGoals(getFinalsCB) {
    ...
    let averageGoals = (finals.reduce((sum, games) => sum + (games['Home Team Goals'] + games['Away Team Goals']), 0) / finals.length).toFixed(2);
    return averageGoals;
}
